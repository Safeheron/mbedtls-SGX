...
void ocall_mbedtls_net_close(mbedtls_net_context *ctx);
 ...
 */
int ocall_mbedtls_net_connect(mbedtls_net_context *ctx, const char *host,
...
int ocall_mbedtls_net_poll(mbedtls_net_context *ctx, uint32_t rw, uint32_t timeout)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    struct timeval tv;
 ...
 */
int ocall_mbedtls_net_recv_timeout(void *ctx, unsigned char *buf,
